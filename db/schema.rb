...
ActiveRecord::Schema.define(version: 20180428191226) do
  ...
  create_table "suits", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["client_id"], name: "index_suits_on_client_id"
    t.index ["lawyer_id"], name: "index_suits_on_lawyer_id"
  end

  add_foreign_key "suits", "clients"
  add_foreign_key "suits", "lawyers"
end
